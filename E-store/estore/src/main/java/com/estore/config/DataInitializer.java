...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Product sac = productRepository.save(Product.builder()
                ...
                .price(249.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Sac+Etudiant")
        ...
        Product cahiers = productRepository.save(Product.builder()
                ...
                .price(89.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Cahiers")
                .category(fournitures).build());
        ...
        Product stylos = productRepository.save(Product.builder()
                ...
                .price(45.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Stylos+Bic")
                .category(fournitures).build());
        ...
        Product geo = productRepository.save(Product.builder()
                ...
                .price(55.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Kit+Geometrie")
                .category(fournitures).build());
        ...
        Product calculatrice = productRepository.save(Product.builder()
                ...
                .price(299.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Casio+FX-82")
                .category(fournitures).build());
        ...
        Product algoBook = productRepository.save(Product.builder()
                ...
                .price(220.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Algo+Livre")
        ...
        Product webBook = productRepository.save(Product.builder()
                ...
                .price(280.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Web+Livre")
                .category(livres).build());
        ...
        Product dbBook = productRepository.save(Product.builder()
                ...
                .price(195.00)
                .imageUrl("https://via.placeholder.com/300x300?text=BDD+Livre")
                .category(livres).build());
        ...
        Product mathBook = productRepository.save(Product.builder()
                ...
                .price(175.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Maths+Livre")
                .category(livres).build());
        ...
        Product laptop = productRepository.save(Product.builder()
                ...
                .price(6499.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Lenovo+IdeaPad")
        ...
        Product tablette = productRepository.save(Product.builder()
                ...
                .price(2199.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Samsung+Tab+A8")
                .category(informatique).build());
        ...
        Product souris = productRepository.save(Product.builder()
                ...
                .price(199.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Souris+Logitech")
                .category(informatique).build());
        ...
        Product cle = productRepository.save(Product.builder()
                ...
                .price(99.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Cle+USB+64GB")
                .category(informatique).build());
        ...
        Product casque = productRepository.save(Product.builder()
                ...
                .price(449.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Casque+JBL")
                .category(informatique).build());
        ...
        Product classeur = productRepository.save(Product.builder()
                ...
                .price(75.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Classeurs+A4")
        ...
        Product ramette = productRepository.save(Product.builder()
                ...
                .price(65.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Ramette+A4")
                .category(papeterie).build());
        ...
        Product surligneurs = productRepository.save(Product.builder()
                ...
                .price(39.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Surligneur+Stabilo")
                .category(papeterie).build());
        ...
        Product agenda = productRepository.save(Product.builder()
                ...
                .price(89.00)
                .imageUrl("https://via.placeholder.com/300x300?text=Agenda+Univ")
                .category(papeterie).build());
